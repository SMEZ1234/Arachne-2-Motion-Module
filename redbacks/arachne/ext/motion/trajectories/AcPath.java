...
/**
 * Replaces the AcTrajectory of previous versions of Arachne.
 * There's no motion profiling here, but rather two {@link PIDController PIDControllers} being combined to control linear and rotational movement of the robot along a path.
 *
 * @author Sean Zammit
 */
