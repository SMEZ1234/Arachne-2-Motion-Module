...
public class AcMultiPID extends Action
{
	 ...
	 * This class will sum together all inputs for generic simple functionality. For more advanced control extend and override the combine() function with your own combining code.
	 * 
	...
	{
		/**
		 * Combines the output from multiple {@link PIDAxis} instances, to pass to a PIDOutput.
		 * Override this method if you need to have more advanced control than a simple addition.
		 *
		 * @param axes The PIDAxes to combine.
		 * @return The combined value to pass to a PIDOutput.
		 */
